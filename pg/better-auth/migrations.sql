create table "user" ("id" text not null primary key, "name" text not null, "email" text not null unique, "image" text, "createdAt" timestamp not null, "updatedAt" timestamp not null);
